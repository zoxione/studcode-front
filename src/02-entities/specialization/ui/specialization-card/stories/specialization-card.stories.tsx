...
import { SpecializationCard } from "../ui/specialization-card"

const meta = {
  title: "Specialization/SpecializationCard",
  component: SpecializationCard,
  parameters: {},
  tags: ["autodocs"],
  argTypes: {},
} satisfies Meta<typeof SpecializationCard>
...
export const Default: StoryFn = () => (
  <TooltipProvider>
    <SpecializationCard specialization={mockSpecialization} />
  </TooltipProvider>
)
